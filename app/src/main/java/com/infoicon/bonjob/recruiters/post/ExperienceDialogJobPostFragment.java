...
public class ExperienceDialogJobPostFragment extends DialogFragment {
    ...
    private void init() {
        ...
        tvTitle.setText(getResources().getString(R.string.experience));
      ...
      //  String[] mTestArray = getResources().getStringArray(R.array.array_experience);
        String[] mTestArray=  new String[getJobpostDropDown.getExperiences()
                .size()];
        for(int i=0;i< getJobpostDropDown.getExperiences().size();i++)
        {
            mTestArray[i]=getJobpostDropDown.getExperiences().get(i)
                    .getExperience();
        ...
        listView.setAdapter(arrayAdapter);
                ...
                public void onClick(View v) {
                    ...
                    if (checked.size() > 0) {
                        ...
                        for (int i = 0; i < checked.size(); i++) {
                            ...
                            if (checked.valueAt(i)) {
                                ...
                                if (str == null) {
                                    ...
                                    valueId=getJobpostDropDown.getExperiences().
                                            get(position)
                                            .getExperience_id();
                                    ...
                                    valueId=valueId+ ","+getJobpostDropDown.getExperiences().get(position)
                                            .getExperience_id();
                                }
                            }
                        }
                      //  if (array.size() > 0) {
                            ...
                            intent.putExtra(Keys.EXPERIENCE,value);
                           intent.putExtra(Keys.EXPERIENCEID, valueId);
            ...
            if (!bundle.containsKey(Keys.TYPE)) {
                ...
                listView.setOnItemClickListener((parent, views, position, id) ->
                {
                    ...
                    intent.putExtra(Keys.EXPERIENCE, mTestArray[position]);
                    intent.putExtra(Keys.EXPERIENCEID, getJobpostDropDown.
                            getExperiences()
                    .get(position).getExperience_id());
                    getTargetFragment().onActivityResult(getTargetRequestCode(), Activity.RESULT_OK, intent);
                    getDialog().dismiss();
                });
            }
