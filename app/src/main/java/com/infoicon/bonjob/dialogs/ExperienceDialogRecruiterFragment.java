...
public class ExperienceDialogRecruiterFragment extends DialogFragment {
    ...
    private void init() {
      ...
      //  String[] mTestArray = getResources().getStringArray(R.array.array_experience);
        String[] mTestArray=  new String[jobSearchDropDownResponce.getExperiences()
                .size()];
        for(int i=0;i< jobSearchDropDownResponce.getExperiences().size();i++)
        {
            mTestArray[i]=jobSearchDropDownResponce.getExperiences().get(i).getExperience();
                        ...
                        for (int i = 0; i < checked.size(); i++) {
                            ...
                            if (checked.valueAt(i)) {
                                ...
                                if (str == null) {
                                    ...
                                    valueId=jobSearchDropDownResponce.getExperiences().get(position)
                                            .getExperience_id();

                                } else {
                                    str = str + "#" + position;
                                    value=value + ","+arrayAdapter.getItem(position);
                                    valueId=valueId+ ","+jobSearchDropDownResponce.getExperiences().get(position)
                                            .getExperience_id();
                                }
                            }
                        }
