...
public class DiplomaDialogFragment extends DialogFragment {
    JsonArray array;
    com.infoicon.bonjob.splash.GetAllDropDownResponce GetAllDropDownResponce;
    ...
    private void init() {
                    ...
                    for (int i = 0; i < checked.size(); i++) {
                        ...
                        if (checked.valueAt(i)) {
                            ...
                            if (str == null) {
                                ...
                                valueId=GetAllDropDownResponce.getEducationLevels().get(position)
                                        .getEducation_id();
                            } else {
                                str = str + "#" + position;
                                value=value + ","+arrayAdapter.getItem(position);
                                valueId=valueId+ ","+GetAllDropDownResponce.getEducationLevels().get(position)
                                        .getEducation_id();
                            }
                        }
                    }
       ...
       // String[] mTestArray = getResources().getStringArray(R.array.education_level);
        ...
        String[] mTestArray=  new String[GetAllDropDownResponce.getEducationLevels()
                .size()];
        for(int i=0;i< GetAllDropDownResponce.getEducationLevels().size();i++)
        {
            mTestArray[i]=GetAllDropDownResponce.getEducationLevels().get(i).getEducation_title();
