...
public class DiplomaDialogRecruiterFragment extends DialogFragment {
    JsonArray array;
                    ...
                    for (int i = 0; i < checked.size(); i++) {
                        ...
                        if (checked.valueAt(i)) {
                            ...
                            if (str == null) {
                                ...
                                valueId=jobSearchDropDownResponce.getEducationLevels().get(position)
                                        .getEducation_id();
                            } else {
                                str = str + "#" + position;
                                value=value + ","+arrayAdapter.getItem(position);
                                valueId=valueId+ ","+jobSearchDropDownResponce.getEducationLevels().get(position)
                                        .getEducation_id();
                            }
                        }
                    }
