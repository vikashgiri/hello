...
public class SalaryEdProfileDialogFragment extends DialogFragment {
    ...
    private void init() {
        ...
        tvTitle.setText(getResources().getString(R.string.num_salary));
      //  String[] mTestArray = getResources().getStringArray(R.array.array_ed_profile_salary);
        mTestArray=  new String[getEmpProfileDropdownsResponce.
                getNumberOfEmployees()
                .size()];
        for(int i=0;i< getEmpProfileDropdownsResponce.getNumberOfEmployees().size();i++)
        {
            mTestArray[i]=getEmpProfileDropdownsResponce.getNumberOfEmployees().get(i)
                    .getNumber_of_employee_title();
        ...
        listView.setOnItemClickListener((parent, views, position, id) -> {
            ...
            intent.putExtra(Keys.SALARY_ID,
                    getEmpProfileDropdownsResponce.getNumberOfEmployees().get(position)
            .getNumber_of_employee_id());
