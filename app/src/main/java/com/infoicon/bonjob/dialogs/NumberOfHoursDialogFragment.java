...
public class NumberOfHoursDialogFragment extends DialogFragment {
    ...
    private void init() {
       ...
       // String[] mTestArray = getResources().getStringArray(R.array.array_num_hour);
        ...
        String[] mTestArray=  new String[jobSearchDropDownResponce.getNumberOfHours()
                .size()];
        for(int i=0;i< jobSearchDropDownResponce.getNumberOfHours().size();i++)
        {
            mTestArray[i]=jobSearchDropDownResponce.getNumberOfHours().get(i).getHours_title();
                    ...
                    for (int i = 0; i < checked.size(); i++) {
                        ...
                        if (checked.valueAt(i)) {
                            ...
                            if (str == null) {
                                ...
                                valueId=jobSearchDropDownResponce.getNumberOfHours().get(position)
                                        .getHours_id();

                            } else {
                                str = str + "#" + position;
                                value=value + ","+arrayAdapter.getItem(position);
                                valueId=valueId+ ","+jobSearchDropDownResponce.getNumberOfHours().get(position)
                                        .getHours_id();
                            }
                        }
                    }
