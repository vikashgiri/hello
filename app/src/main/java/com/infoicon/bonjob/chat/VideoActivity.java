...
public class VideoActivity extends AppCompatActivity {
    ...
    public static  AppCompatActivity VideoActivity;
    ...
    private static String LOCAL_ROOMNAME = "";
    ...
    private FloatingActionButton dis_connect_action_fab;
    private FloatingActionButton dis_connect_action_fab1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dis_connect_action_fab = findViewById(R.id.dis_connect_action_fab);
        dis_connect_action_fab1 = findViewById(R.id.dis_connect_action_fab1);
        switchCameraActionFab = findViewById(R.id.switch_camera_action_fab);
        localVideoActionFab = findViewById(R.id.local_video_action_fab);
        muteActionFab = findViewById(R.id.mute_action_fab);
        ((TextView)findViewById(R.id.name))
                .setText(StaticConfig.to_name_chatter);
...
if(intent.hasExtra(Keys.NAME))
{
      ...
      //  if (from.equals(Keys.NOTIFICATION)) {
            ...
            LOCAL_ROOMNAME = intent.getStringExtra(Keys.NAME);
            accessToken = intent.getStringExtra(Keys.DEVICE_TOKEN);
...
/*        connectActionFab.setImageDrawable(ContextCompat.getDrawable(this,
        ...
        dis_connect_action_fab.setImageDrawable(ContextCompat.getDrawable(this,
                R.drawable.ic_call_black_24dp));*/
    /*    connectActionFab.setImageDrawable(ContextCompat.getDrawable(this,
                R.drawable.ic_call_end_white_24px));*/

       // dis_connect_action_fab.show();
        dis_connect_action_fab.setOnClickListener(disconnectClickListener());
    ...
    private void addRemoteParticipant(RemoteParticipant remoteParticipant) {
         ...
         */
        dis_connect_action_fab1.setOnClickListener(disconnectClickListener());
   ...
   private void retrieveAccessTokenfromServer()
    {
        ...
        jsonObject.addProperty(Keys.USER_ID, StaticConfig.BID);
        jsonObject.addProperty("room_name", StaticConfig.UID+""+StaticConfig.BID);
        retrofit.Call<TulipResponce>

            call = AppRetrofit.getAppRetrofitInstance().getApiServices()
                    .getTulipResponse(jsonObject);

        ServiceCreator.enqueueCall(call, new retrofit.Callback<TulipResponce>() {
            @Override
            public void onResponse(retrofit.Response<TulipResponce> response, retrofit.Retrofit retrofit)
            {
                spotsDialog.dismiss();
                TulipResponce getForgotPasswordResponse = response.body();
                if (getForgotPasswordResponse.isSuccess()) {
                 VideoActivity.this.accessToken = getForgotPasswordResponse.getData().getGrant_access_token();
                 VideoActivity.this.LOCAL_ROOMNAME = getForgotPasswordResponse.getData().getRoom_name();
                 // VideoActivity.this.accessToken="eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiIsImN0eSI6InR3aWxpby1mcGE7dj0xIn0..aIj6myr3UdPqYmNE71VKjTBXtjJE6UIKCoa7dl8p6V4";
                   // VideoActivity.this.accessToken="eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiIsImN0eSI6InR3aWxpby1mcGE7dj0xIn0..FgrhOQfoaXQEA0xPbINaoGFlqurX8SDbFN4mqamZ0I0";
                    connectActionFab.callOnClick();
                   /* ((TextView)findViewById(R.id.name))
                            .setText(StaticConfig.to_name_chatter);*/
                } else {
                    CommonUtils.showSimpleMessageBottom(VideoActivity.this,
            ...
            public void onFailure(Throwable t) {
                spotsDialog.dismiss();
                CommonUtils.showSimpleMessageBottom(VideoActivity.this, t.getMessage());
            }
        });
    }
    ...
    private void disconnectfromServer()
    {
        ...
        jsonObject.addProperty(Keys.USER_ID, StaticConfig.BID);
     //   jsonObject.addProperty("room_name", StaticConfig.UID+""+StaticConfig.BID);
        retrofit.Call<DisconnectCallResponce>

                call = AppRetrofit.getAppRetrofitInstance().getApiServices()
                .getTulipDisconnectResponse(jsonObject);

        ServiceCreator.enqueueCall(call, new retrofit.Callback<DisconnectCallResponce>() {
            @Override
            public void onResponse(retrofit.Response<DisconnectCallResponce> response, retrofit.Retrofit retrofit)
            {
     ...
     * call web service for get login
     */
    private void DeclineCallServer()
    {
        //{"":"3785","room_name":"test"}
        final SpotsDialog spotsDialog = new SpotsDialog(this, R.style.Custom);
        spotsDialog.setCancelable(false);
        ...
        retrofit.Call<DisconnectCallResponce>
                ...
                call = AppRetrofit.getAppRetrofitInstance().getApiServices()
                .getTulipDeclineResponse(jsonObject);
