package com.infoicon.bonjob.permission;
...
public class PermissionKeys {
    ...
    public static final int REQUEST_CODE_WRITE_EXTERNAL_STORAGE_1=121;
    public static final int REQUEST_CODE_WRITE_EXTERNAL_STORAGE_2=122;


    public static final int REQUEST_CODE_PERMISSION_ALL=13;
    public static final int REQUEST_CODE_PERMISSION_ALL2=16;
    public static final int REQUEST_CODE_PERMISSION_ALL_PHOTO=14;
    public static final int REQUEST_CODE_PERMISSION_ALL_VIDEO=15;
